...
CHoverButton::CHoverButton(vgui::Panel *parent, const char *panelName)
...
CMainMenuSystem::CMainMenuSystem()
    : CAutoGameSystem("CMainMenuSystem")
{
}
...
CMainMenu::CMainMenu( VPANEL parent ) : Panel(NULL, "MainMenu")
{
    ...
    m_pLogo->SetBounds(120, 25, 256, 256); 
